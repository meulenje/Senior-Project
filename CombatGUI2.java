...
public class CombatGUI2 extends JPanel implements ActionListener, KeyListener {
	...
	public CombatGUI2(GameEngine tempEngine)
	{
		...
		targets = new JComboBox<String>(); // pass String[] of list to this object
		...
		actionTextScrollBar.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
	...
	/**
	 * Updates the text of the status label layer.
	 * Note: this function only updates the text, if
	 * you want to view the text, you need to call
	 * viewStatusPanel()
	 * @param newStatus
	 */
