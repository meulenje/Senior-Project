...
public class GameEngine implements ActionListener, FocusListener, ClockListener {
	...
	protected double percentChanceOfEncounter = 0.1; // when entering a
														// Encounterable space,
														// there is a small
														// chance the player
														// will run into a
	...
	ArrayList<CombatObject> combatObjects;
	...
	public GameEngine() {
		...
		Entity mario = new Entity(Player, "Mario", true, 200, 200, 10, 10, 10);
		Entity luigi = new Entity(Player, "Luigi", true, 200, 200, 10, 10, 10);
		Ability cure = new Ability("Cure", 1, 0, 0);
		Ability fireball = new Ability("Fireball", 0, 1, 0);
	...
	public String printQuestion(String t) {
		return JOptionPane.showInputDialog(window, t, "Question",
	...
	public int printYesNoQuestion(String b) {
		return JOptionPane.showConfirmDialog(window, b, "Question",
	...
	public int printCustomQuestion(String question, Object[] choices) {
		return JOptionPane.showOptionDialog(window, question, "Question",
		...
		// check if the next spot is pushable like a rock
			...
			if (!nearEdgeOfMap
				...
				board[prow + x + x][pcol + y + y]
						.setEntity(board[prow + x][pcol + y].getEntity());
